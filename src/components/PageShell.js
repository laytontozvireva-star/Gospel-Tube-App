    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {user ? (
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-red-600 text-white flex items-center justify-center font-bold text-sm shadow-md shadow-red-600/20 uppercase">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          {/* Sidebar Bottom: User Account Section */}
          {user ? (
            <div className="border-t border-slate-200 pt-4 mt-4 shrink-0 hidden lg:block">
              <div className="flex items-center gap-3 px-2 mb-3">
                <div className="w-10 h-10 rounded-full bg-red-600 text-white flex items-center justify-center font-bold text-sm uppercase shrink-0 shadow-sm">
                  {user.name ? user.name.charAt(0) : "U"}
                </div>
              ...
              <button
                onClick={signOut}
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-slate-600 hover:bg-red-50 hover:text-red-600 transition-all"
              >
                <LogOut size={18} />
                Sign Out
              </button>
            ...
            <div className="border-t border-slate-200 pt-4 mt-4 shrink-0 hidden lg:block space-y-2">
              <button
                className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold py-2.5 rounded-xl transition-all shadow-sm"
                onClick={() => setSigninOpen(true)}
              >
                Sign In
              </button>
              <button
                className="w-full flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-semibold py-2.5 rounded-xl transition-all"
                onClick={() => setSigninOpen(true)}
              >
                <UserPlus size={16} />
                Sign Up
